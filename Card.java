...
public class Card implements Comparable<Card> {
    ...
    public Rank getRank() { 
        return this.prototype.rank;
    }

    /** Accessor for suit of this card */
    public Suit suit() { 
        return this.prototype.suit; 
    }

    /** Text description of card = RANK of SUIT */
    public String toString() { 
        return this.prototype.rank + " of " + this.prototype.suit; 
    }

    /** Accessor for image of this card */
    public Image getFrontSide() {
        return this.prototype.frontSide;
    }
    ...
    public int compareTo(Card c2) {
        return 13*this.prototype.suit.compareTo(c2.prototype.suit)
            +this.prototype.rank.compareTo(c2.prototype.rank);
    }
    ...
    /** Generates a new deck of face-down cards */
    public static Card[] smallDeck(int numCards) {
            ...
            for (int i = 0; i < ranks.length; i++) {
                for (int j = 0; j < suits.length; j++) {
                    ...
                    protoDeck[i+ranks.length*j].frontSide = 
                        toolkit.getImage(new java.net.URL("http://cs.smith.edu/~nhowe/teaching/csc112/Graphics/"+id+".png"));
